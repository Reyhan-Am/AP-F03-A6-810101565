#include "put.hpp"
#include "Utaste.hpp"
Putter::Putter(string districts_path, string restaurants_path, string discounts_path, UTaste &utaste_ref) : Command(districts_path, restaurants_path, discounts_path, utaste_ref), utaste(&utaste_ref) {}
void Putter::checkCommand(vector<string> command_words, string &test)
{
